...
public class P_U {
    public static void main(String args[]) 
    {
       ...
       int temp = 1;
       while(temp == 1){
        System.out.println("1.Wrap  2.UnWrap 3.Exit");
    ...
    public static void Wrapper(){
        ...
        System.out.println("--------Welcome to Wrapper UnWrapper ----------");
        System.out.println("Wrapping activity of the application is started...");
        System.out.println("Enter the  name of folder which contains the files that you want to wrap : ");
        String FolderName = sobj.nextLine();

        File fobj = new File(FolderName);
        String Header = null;

        System.out.println("Enter the name of wrapped file you want to createe : ");
